#=**
* Ported from OpenCLBLAS dSYR2 example (example_ssyr2.c)
* Qijia (Michael) Jin
* @version 0.0.1
*
...
function clblasDsyr2(o,ul,N,alpha,X,offX,incX,Y,offY,incY,A,offA,lda,ncq,cq,ne,wle,e)
	return ccall((:clblasDsyr2, libclblas), cl_int, (clblasOrder,
		clblasUplo,
		Csize_t,#N
		cl_double,#alpha
		cl_mem,#X
...
=====#
	...
	statusCheck(clblasDsyr2(order, uplo, N, alpha, bufX, 0, incX, bufY, 0, incY, bufA, 0, lda, 1, queue, 0, C_NULL, event))
