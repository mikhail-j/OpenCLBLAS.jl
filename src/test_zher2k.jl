#=**
* Ported from OpenCLBLAS zHER2K example (example_cher2k.c)
* Qijia (Michael) Jin
* @version 0.0.1
*
...
function clblasZher2k(order,uplo,transA,N,K,alpha,A,offA,lda,B,offB,ldb,beta,C,offC,ldc,ncq,cq,ne,wle,e)
	return ccall((:clblasZher2k, libclblas), clblasStatus, (clblasOrder,
		clblasUplo,
		clblasTranspose,
		Csize_t,#N
		Csize_t,#K
		...
		Ptr{cl_event},
		Ptr{cl_event}),
		order,uplo,transA,N,K,alpha,A,offA,lda,B,offB,ldb,beta,C,offC,ldc,ncq,cq,ne,wle,e)
end
...
hcat(clblasDoubleComplex(11, 0), clblasDoubleComplex(12, 0), clblasDoubleComplex(13, 0), clblasDoubleComplex(14, 0));
hcat(clblasDoubleComplex(21, 0), clblasDoubleComplex(22, 0), clblasDoubleComplex(23, 0), clblasDoubleComplex(24, 0));
hcat(clblasDoubleComplex(31, 0), clblasDoubleComplex(32, 0), clblasDoubleComplex(33, 0), clblasDoubleComplex(34, 0));
hcat(clblasDoubleComplex(41, 0), clblasDoubleComplex(42, 0), clblasDoubleComplex(43, 0), clblasDoubleComplex(44, 0));
hcat(clblasDoubleComplex(51, 0), clblasDoubleComplex(52, 0), clblasDoubleComplex(53, 0), clblasDoubleComplex(54, 0))]);
	B =	convert(Array{clblasDoubleComplex,2}, [
hcat(clblasDoubleComplex(1, 0), clblasDoubleComplex(2, 0), clblasDoubleComplex(3, 0), clblasDoubleComplex(4, 0));
hcat(clblasDoubleComplex(2, 0), clblasDoubleComplex(2, 0), clblasDoubleComplex(3, 0), clblasDoubleComplex(4, 0));
hcat(clblasDoubleComplex(3, 0), clblasDoubleComplex(2, 0), clblasDoubleComplex(3, 0), clblasDoubleComplex(3, 0));
hcat(clblasDoubleComplex(4, 0), clblasDoubleComplex(4, 0), clblasDoubleComplex(4, 0), clblasDoubleComplex(4, 0));
hcat(clblasDoubleComplex(5, 0), clblasDoubleComplex(5, 0), clblasDoubleComplex(5, 0), clblasDoubleComplex(5, 0))]);
...
hcat(clblasDoubleComplex( 0, 0), clblasDoubleComplex( 0, 0), clblasDoubleComplex( 0, 0), clblasDoubleComplex( 0, 0), clblasDoubleComplex(55, 6))]);
	...
	alpha[1] = clblasDoubleComplex(10,1);
	beta = cl_double(1);
	...
	statusCheck(err[1])
	err = Array(cl_int, 1)
	bufB = clCreateBuffer(ctx, CL_MEM_READ_ONLY, N * K * sizeof(clblasDoubleComplex), C_NULL, err)
	statusCheck(err[1])
	err = Array(cl_int, 1)
	...
	event[1] = C_NULL
	statusCheck(clEnqueueWriteBuffer(queue[1], bufB, CL_TRUE, Csize_t(0), N * K * sizeof(clblasDoubleComplex), B.', cl_uint(0), C_NULL, event))
	statusCheck(clWaitForEvents(1,event))
	statusCheck(clReleaseEvent(event[1]))		#free the memory
	event[1] = C_NULL
...
=====#
	...
	statusCheck(clblasZher2k(order, uplo, transA, N, K, alpha, bufA, 0, lda, bufB, 0, ldb,
		beta, bufC, 0, ldc, 1, queue, 0, C_NULL, event))
