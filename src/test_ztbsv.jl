#=**
* Ported from OpenCLBLAS zTBSV example (example_stbsv.c)
* Qijia (Michael) Jin
* @version 0.0.1
*
...
function clblasZtbsv(o,ul,t,diag,N,K,A,offA,lda,X,offX,incX,ncq,cq,ne,wle,e)
	return ccall((:clblasZtbsv, libclblas), cl_int, (clblasOrder,
		clblasUplo,
		clblasTranspose,
		clblasDiag,
		Csize_t,#N
...
=====#
	...
	statusCheck(clblasZtbsv(order, uplo, trans, diag, N, K, bufA, 0, lda, bufX, 0, incX, 1, queue, 0, C_NULL, event))
