#=**
* Ported from OpenCLBLAS zGERU example (example_sger.c)
* Qijia (Michael) Jin
* @version 0.0.1
*
...
function clblasZgeru(o,M,N,alpha,X,offX,incX,Y,offY,A,offA,lda,incY,ncq,cq,ne,wle,e)
	return ccall((:clblasZgeru, libclblas), cl_int, (clblasOrder,
		Csize_t,#M
		Csize_t,#N
...
=====#
	...
	statusCheck(clblasZgeru(order, M, N, alpha, bufX, 0, incX, bufY, 0, incY, bufA, 0, lda, 1, queue, 0, C_NULL, event))
