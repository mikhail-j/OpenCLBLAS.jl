#=**
* Ported from OpenCLBLAS dTRMM example (example_strmm.c)
* Qijia (Michael) Jin
* @version 0.0.1
*
...
function clblasDtrmm(o,side,ul,tA,diag,M,N,alpha,A,offA,lda,B,offB,ldb,ncq,cq,ne,wle,e)
	return ccall((:clblasDtrmm, libclblas), cl_int, (clblasOrder,
		clblasSide,
		clblasUplo,
		clblasTranspose,
		clblasDiag,
...
=====#
	...
	statusCheck(clblasDtrmm(order, side, uploA, transA, diagA, M, N,
