#=**
* Ported from OpenCLBLAS sSPR example (example_sspr.c)
* Qijia (Michael) Jin
* @version 0.0.1
*
...
function clblasSspr(o,ul,N,alpha,X,offX,incX,A,offA,ncq,cq,ne,wle,e)
	return ccall((:clblasSspr, libclblas), cl_int, (clblasOrder,
		clblasUplo,
		Csize_t,#N
		cl_float,#alpha
		cl_mem,#X
		...
		Ptr{cl_event},
		Ptr{cl_event}),
		o,ul,N,alpha,X,offX,incX,A,offA,ncq,cq,ne,wle,e)
end
...
=====#
	...
	statusCheck(clblasSspr(order, uplo, N, alpha, bufX, 0, incX, bufA, 0, 1, queue, 0, C_NULL, event))
