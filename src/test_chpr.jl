#=**
* Ported from OpenCLBLAS cHPR example (example_chpr.c)
* Qijia (Michael) Jin
* @version 0.0.1
*
...
function clblasChpr(order,uplo,N,alpha,X,offX,incX,A,offA,ncq,cq,ne,wle,e)
	return ccall((:clblasChpr, libclblas), clblasStatus, (clblasOrder,
		clblasUplo,
		Csize_t,#N
		cl_float,#alpha
		cl_mem,#X
...
clblasFloatComplex(11.0, 00.0), clblasFloatComplex(12.0, 02.0), clblasFloatComplex(13.0, 05.0), clblasFloatComplex(14.0, 12.0), clblasFloatComplex(15.0, 06.0),
	...
	X = convert(Array{clblasFloatComplex,1}, [clblasFloatComplex(11.0, 23.0),clblasFloatComplex(21.0, 65.0),clblasFloatComplex(31.0, 20.0),clblasFloatComplex(41.0, 02.0),clblasFloatComplex(51.0, 10.0)]);
...
=====#
	...
	statusCheck(clblasChpr(order, uplo, N, alpha, bufX, 0, incX,
