#=**
* Ported from OpenCLBLAS dSBMV example (example_ssbmv.c)
* Qijia (Michael) Jin
* @version 0.0.1
*
...
function clblasDsbmv(o,ul,N,K,alpha,A,lda,offA,X,offX,incX,beta,Y,offY,incY,ncq,cq,ne,wle,e)
	return ccall((:clblasDsbmv, libclblas), cl_int, (clblasOrder,
		clblasUplo,
		Csize_t,#N
		Csize_t,#K
		cl_double,#alpha
...
=====#
	...
	statusCheck(clblasDsbmv(order, uplo, N, K, alpha, bufA, 0, lda, bufX, 0, incX, beta, bufY, 0, incY, 1, queue, 0, C_NULL, event))
