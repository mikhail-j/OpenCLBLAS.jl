#=**
* Ported from OpenCLBLAS cTRSM example (example_strsm.c)
* Qijia (Michael) Jin
* @version 0.0.1
*
...
function clblasCtrsm(o,side,ul,tA,diag,M,N,alpha,A,offA,lda,B,offB,ldb,ncq,cq,ne,wle,e)
	return ccall((:clblasCtrsm, libclblas), cl_int, (clblasOrder,
		clblasSide,
		clblasUplo,
		clblasTranspose,
		clblasDiag,
...
=====#
	...
	statusCheck(clblasCtrsm(order, side, uploA, transA, diagA, M, N,
