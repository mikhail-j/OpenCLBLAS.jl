#=**
* Ported from OpenCLBLAS sTBSV example (example_stbsv.c)
* Qijia (Michael) Jin
* @version 0.0.1
*
...
function clblasStbsv(o,ul,t,diag,N,K,A,offA,lda,X,offX,incX,ncq,cq,ne,wle,e)
	return ccall((:clblasStbsv, libclblas), cl_int, (clblasOrder,
		clblasUplo,
		clblasTranspose,
		clblasDiag,
		Csize_t,#N
...
=====#
	...
	statusCheck(clblasStbsv(order, uplo, trans, diag, N, K, bufA, 0, lda, bufX, 0, incX, 1, queue, 0, C_NULL, event))
