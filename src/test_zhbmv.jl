#=**
* Ported from OpenCLBLAS zHBMV example (example_chbmv.c)
* Qijia (Michael) Jin
* @version 0.0.1
*
...
function clblasZhbmv(o,uplo,N,K,alpha,A,offA,lda,X,offX,incX,beta,Y,offY,incY,ncq,cq,ne,wle,e)
	return ccall((:clblasZhbmv, libclblas), cl_int, (clblasOrder,
		clblasUplo,
		Csize_t,#N
		Csize_t,#K
...
hcat(clblasDoubleComplex( 4.0,  4.0), clblasDoubleComplex( 7.0,  7.0), clblasDoubleComplex(11.0, 11.0));
hcat(clblasDoubleComplex( 5.0,  5.0), clblasDoubleComplex( 8.0,  8.0), clblasDoubleComplex(12.0, 12.0));
hcat(clblasDoubleComplex( 6.0,  6.0), clblasDoubleComplex( 9.0,  9.0), clblasDoubleComplex(13.0, 13.0));
hcat(clblasDoubleComplex(10.0, 10.0), clblasDoubleComplex(14.0, 14.0), clblasDoubleComplex(00.0, 00.0));
hcat(clblasDoubleComplex(15.0, 15.0), clblasDoubleComplex(00.0, 00.0), clblasDoubleComplex(00.0, 00.0))])
...
=====#
	...
	statusCheck(clblasZhbmv(order, uplo, N, K, alpha, bufA, 0, lda, bufX, 0, incX, beta, bufY, 0, incY, 1, queue, 0, C_NULL, event))
