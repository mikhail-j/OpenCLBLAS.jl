#=**
* Ported from OpenCLBLAS zTPMV example (example_stpmv.c)
* Qijia (Michael) Jin
* @version 0.0.1
*
...
function clblasZtpmv(o,ul,tA,diag,N,A,offA,X,offX,incX,sb,ncq,cq,ne,wle,e)
	return ccall((:clblasZtpmv, libclblas), cl_int, (clblasOrder,
		clblasUplo,
		clblasTranspose,
		clblasDiag,
		Csize_t,#N
...
=====#
	...
	statusCheck(clblasZtpmv(order, uploA, transA, diagA,  N, bufA, 0, bufX, 0, incX, sbuf, 1, queue, 0, C_NULL, event))
