#=**
* Ported from OpenCLBLAS cHBMV example (example_chbmv.c)
* Qijia (Michael) Jin
* @version 0.0.1
*
...
function clblasChbmv(o,uplo,N,K,alpha,A,offA,lda,X,offX,incX,beta,Y,offY,incY,ncq,cq,ne,wle,e)
	return ccall((:clblasChbmv, libclblas), cl_int, (clblasOrder,
		clblasUplo,
		Csize_t,#N
		Csize_t,#K
		...
		Ptr{cl_event},
		Ptr{cl_event}),
		o,uplo,N,K,alpha,A,offA,lda,X,offX,incX,beta,Y,offY,incY,ncq,cq,ne,wle,e)
end
...
hcat(clblasFloatComplex( 4.0,  4.0), clblasFloatComplex( 7.0,  7.0), clblasFloatComplex(11.0, 11.0));
hcat(clblasFloatComplex( 5.0,  5.0), clblasFloatComplex( 8.0,  8.0), clblasFloatComplex(12.0, 12.0));
hcat(clblasFloatComplex( 6.0,  6.0), clblasFloatComplex( 9.0,  9.0), clblasFloatComplex(13.0, 13.0));
hcat(clblasFloatComplex(10.0, 10.0), clblasFloatComplex(14.0, 14.0), clblasFloatComplex(00.0, 00.0));
hcat(clblasFloatComplex(15.0, 15.0), clblasFloatComplex(00.0, 00.0), clblasFloatComplex(00.0, 00.0))])
...
=====#
	...
	statusCheck(clblasChbmv(order, uplo, N, K, alpha, bufA, 0, lda, bufX, 0, incX, beta, bufY, 0, incY, 1, queue, 0, C_NULL, event))
