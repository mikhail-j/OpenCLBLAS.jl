#=**
* Ported from OpenCLBLAS dSYRK example (example_ssyrk.c)
* Qijia (Michael) Jin
* @version 0.0.1
*
...
function clblasDsyrk(o,ul,t,N,K,alpha,A,offA,lda,beta,C,offC,ldc,ncq,cq,ne,wle,e)
	return ccall((:clblasDsyrk, libclblas), cl_int, (clblasOrder,
		clblasUplo,
		clblasTranspose,
		Csize_t,#N
		Csize_t,#K
		...
		Ptr{cl_event},
		Ptr{cl_event}),
		o,ul,t,N,K,alpha,A,offA,lda,beta,C,offC,ldc,ncq,cq,ne,wle,e)
end
...
=====#
	...
	statusCheck(clblasDsyrk(order, uplo, transA, N, K, alpha, bufA, 0, lda, beta, bufC, 0, ldc, 1, queue, 0, C_NULL, event))
