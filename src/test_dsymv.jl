#=**
* Ported from OpenCLBLAS dSYMV example (example_ssymv.c)
* Qijia (Michael) Jin
* @version 0.0.1
*
...
function clblasDsymv(o,ul,N,alpha,A,offA,lda,X,offX,incX,beta,Y,offY,incY,ncq,cq,ne,wle,e)
	return ccall((:clblasDsymv, libclblas), cl_int, (clblasOrder,
		clblasUplo,
		Csize_t,#N
		cl_double,#alpha
		cl_mem,#A
...
=====#
	...
	statusCheck(clblasDsymv(order, uplo, N, alpha, bufA, 0, lda, bufX, 0, incX, beta, bufY, 0, incY, 1, queue, 0, C_NULL, event))
