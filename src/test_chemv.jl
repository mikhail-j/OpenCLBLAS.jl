#=**
* Ported from OpenCLBLAS cHEMV example (example_zhemv.c)
* Qijia (Michael) Jin
* @version 0.0.1
*
...
function clblasChemv(order,uplo,N,alpha,A,offA,lda,X,offX,incX,beta,Y,offY,incY,ncq,cq,ne,wle,e)
	return ccall((:clblasChemv, libclblas), cl_int, (clblasOrder,
		clblasUplo,
		Csize_t,#N
...
hcat(clblasFloatComplex( 1.0, 00.0), clblasFloatComplex( 2.0, 02.0), clblasFloatComplex( 4.0,  4.0), clblasFloatComplex( 7.0,  7.0), clblasFloatComplex(11.0, 11.0));
hcat(clblasFloatComplex(00.0, 00.0), clblasFloatComplex( 3.0, 03.0), clblasFloatComplex( 5.0,  5.0), clblasFloatComplex( 8.0,  8.0), clblasFloatComplex(12.0, 12.0));
hcat(clblasFloatComplex(00.0, 00.0), clblasFloatComplex(00.0, 00.0), clblasFloatComplex( 6.0,  6.0), clblasFloatComplex( 9.0,  9.0), clblasFloatComplex(13.0, 13.0));
hcat(clblasFloatComplex(00.0, 00.0), clblasFloatComplex(00.0, 00.0), clblasFloatComplex(00.0, 00.0), clblasFloatComplex(10.0, 10.0), clblasFloatComplex(14.0, 14.0));
hcat(clblasFloatComplex(00.0, 00.0), clblasFloatComplex(00.0, 00.0), clblasFloatComplex(00.0, 00.0), clblasFloatComplex(00.0, 00.0), clblasFloatComplex(15.0, 15.0))])
	...
	err = Array(cl_int, 1)
	bufA = clCreateBuffer(ctx, CL_MEM_READ_ONLY, N * lda * sizeof(clblasFloatComplex), C_NULL, err)
	statusCheck(err[1])
	err = Array(cl_int, 1)
...
=====#
	...
	statusCheck(clblasChemv(order, uplo, N, alpha, bufA, 0, lda,
		bufX, 0, incX, beta,
	...
	Y2=Array(clblasFloatComplex, length(Y))
	event[1] = C_NULL
