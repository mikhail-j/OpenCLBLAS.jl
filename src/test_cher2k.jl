#=**
* Ported from OpenCLBLAS cHER2K example (example_cher2k.c)
* Qijia (Michael) Jin
* @version 0.0.1
*
...
function clblasCher2k(order,uplo,transA,N,K,alpha,A,offA,lda,B,offB,ldb,beta,C,offC,ldc,ncq,cq,ne,wle,e)
	return ccall((:clblasCher2k, libclblas), clblasStatus, (clblasOrder,
		clblasUplo,
		clblasTranspose,
		Csize_t,#N
		Csize_t,#K
...
hcat(clblasFloatComplex(11, 0), clblasFloatComplex(12, 0), clblasFloatComplex(13, 0), clblasFloatComplex(14, 0));
hcat(clblasFloatComplex(21, 0), clblasFloatComplex(22, 0), clblasFloatComplex(23, 0), clblasFloatComplex(24, 0));
hcat(clblasFloatComplex(31, 0), clblasFloatComplex(32, 0), clblasFloatComplex(33, 0), clblasFloatComplex(34, 0));
hcat(clblasFloatComplex(41, 0), clblasFloatComplex(42, 0), clblasFloatComplex(43, 0), clblasFloatComplex(44, 0));
hcat(clblasFloatComplex(51, 0), clblasFloatComplex(52, 0), clblasFloatComplex(53, 0), clblasFloatComplex(54, 0))]);
	B =	convert(Array{clblasFloatComplex,2}, [
hcat(clblasFloatComplex(1, 0), clblasFloatComplex(2, 0), clblasFloatComplex(3, 0), clblasFloatComplex(4, 0));
hcat(clblasFloatComplex(2, 0), clblasFloatComplex(2, 0), clblasFloatComplex(3, 0), clblasFloatComplex(4, 0));
hcat(clblasFloatComplex(3, 0), clblasFloatComplex(2, 0), clblasFloatComplex(3, 0), clblasFloatComplex(3, 0));
hcat(clblasFloatComplex(4, 0), clblasFloatComplex(4, 0), clblasFloatComplex(4, 0), clblasFloatComplex(4, 0));
hcat(clblasFloatComplex(5, 0), clblasFloatComplex(5, 0), clblasFloatComplex(5, 0), clblasFloatComplex(5, 0))]);
...
hcat(clblasFloatComplex( 0, 0), clblasFloatComplex( 0, 0), clblasFloatComplex( 0, 0), clblasFloatComplex( 0, 0), clblasFloatComplex(55, 6))]);
	...
	statusCheck(err[1])
	err = Array(cl_int, 1)
	bufB = clCreateBuffer(ctx, CL_MEM_READ_ONLY, N * K * sizeof(clblasFloatComplex), C_NULL, err)
	statusCheck(err[1])
	err = Array(cl_int, 1)
	...
	event[1] = C_NULL
	statusCheck(clEnqueueWriteBuffer(queue[1], bufB, CL_TRUE, Csize_t(0), N * K * sizeof(clblasFloatComplex), B.', cl_uint(0), C_NULL, event))
	statusCheck(clWaitForEvents(1,event))
	statusCheck(clReleaseEvent(event[1]))		#free the memory
	event[1] = C_NULL
...
=====#
	...
	statusCheck(clblasCher2k(order, uplo, transA, N, K, alpha, bufA, 0, lda, bufB, 0, ldb,
