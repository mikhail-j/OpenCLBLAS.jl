#=**
* Ported from OpenCLBLAS dSPR example (example_sspr.c)
* Qijia (Michael) Jin
* @version 0.0.1
*
...
function clblasDspr(o,ul,N,alpha,X,offX,incX,A,offA,ncq,cq,ne,wle,e)
	return ccall((:clblasDspr, libclblas), cl_int, (clblasOrder,
		clblasUplo,
		Csize_t,#N
		cl_double,#alpha
		cl_mem,#X
...
=====#
	...
	statusCheck(clblasDspr(order, uplo, N, alpha, bufX, 0, incX, bufA, 0, 1, queue, 0, C_NULL, event))
