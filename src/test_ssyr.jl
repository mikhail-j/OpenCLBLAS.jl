#=**
* Ported from OpenCLBLAS sSYR example (example_ssyr.c)
* Qijia (Michael) Jin
* @version 0.0.1
*
...
function clblasSsyr(o,ul,N,alpha,X,offX,incX,A,offA,lda,ncq,cq,ne,wle,e)
	return ccall((:clblasSsyr, libclblas), cl_int, (clblasOrder,
		clblasUplo,
		Csize_t,#N
		cl_float,#alpha
		cl_mem,#X
...
=====#
	...
	statusCheck(clblasSsyr(order, uplo, N, alpha, bufX, 0, incX, bufA, 0, lda, 1, queue, 0, C_NULL, event))
