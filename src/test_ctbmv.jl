#=**
* Ported from OpenCLBLAS cTBMV example (example_stbmv.c)
* Qijia (Michael) Jin
* @version 0.0.1
*
...
function clblasCtbmv(o,ul,t,diag,N,K,A,offA,lda,X,offX,incX,sb,ncq,cq,ne,wle,e)
	return ccall((:clblasCtbmv, libclblas), cl_int, (clblasOrder,
		clblasUplo,
		clblasTranspose,
		clblasDiag,
		Csize_t,#N
...
=====#
	...
	statusCheck(clblasCtbmv(order, uplo, trans, diag, N, K, bufA, 0, lda, bufX, 0, incX, sbuf, 1, queue, 0, C_NULL, event))
