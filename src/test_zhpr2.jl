#=**
* Ported from OpenCLBLAS zHPR2 example (example_zhpr2.c)
* Qijia (Michael) Jin
* @version 0.0.1
*
...
function clblasZhpr2(order,uplo,N,alpha,X,offX,incX,Y,offY,incY,A,offA,ncq,cq,ne,wle,e)
	return ccall((:clblasZhpr2, libclblas), clblasStatus, (clblasOrder,
		clblasUplo,
		Csize_t,#N
...
clblasDoubleComplex(11.0, 00.0), clblasDoubleComplex(12.0, 02.0), clblasDoubleComplex(13.0, 05.0), clblasDoubleComplex(14.0, 12.0), clblasDoubleComplex(15.0, 06.0),
	...
	X = convert(Array{clblasDoubleComplex,1}, [clblasDoubleComplex(11.0, 03.0),clblasDoubleComplex(01.0, 15.0),clblasDoubleComplex(30.0, 20.0),clblasDoubleComplex(01.0, 02.0),clblasDoubleComplex(11.0, 10.0)]);
	Y = convert(Array{clblasDoubleComplex,1}, [clblasDoubleComplex(11.0, 03.0),clblasDoubleComplex(03.0, 05.0),clblasDoubleComplex(09.0, 00.0),clblasDoubleComplex(01.0, 02.0),clblasDoubleComplex(11.0, 00.0)]);
...
=====#
	...
	statusCheck(clblasZhpr2(order, uplo, N, alpha, bufX, 0, incX, bufY, 0, incY,
