#=**
* Ported from OpenCLBLAS sSYRK example (example_ssyrk.c)
* Qijia (Michael) Jin
* @version 0.0.1
*
...
function clblasSsyrk(o,ul,t,N,K,alpha,A,offA,lda,beta,C,offC,ldc,ncq,cq,ne,wle,e)
	return ccall((:clblasSsyrk, libclblas), cl_int, (clblasOrder,
		clblasUplo,
		clblasTranspose,
		Csize_t,#N
		Csize_t,#K
...
=====#
	...
	statusCheck(clblasSsyrk(order, uplo, transA, N, K, alpha, bufA, 0, lda, beta, bufC, 0, ldc, 1, queue, 0, C_NULL, event))
